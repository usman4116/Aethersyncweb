  ...
  return (
    <div className={`w-[1250px] h-[750px] bg-[#0c0c0c] light:bg-[#ffffff] text-[#cccccc] light:text-[#333333] font-sans flex flex-col select-none overflow-hidden rounded-xl border border-white/10 light:border-black/10 shadow-2xl ${className}`}>
      ...
      <div className="flex-1 flex overflow-hidden">
                  ...
                  <div
                    ...
                    className={`px-2.5 py-2 rounded-lg text-xs cursor-pointer flex flex-col transition-all ${
                      selectedChat === chat.id
                        ? 'bg-[#222222] light:bg-[#e5e7eb] text-white light:text-black border border-white/10 light:border-black/10 font-medium'
                        : 'text-gray-400 light:text-gray-600 hover:bg-white/5 light:hover:bg-black/5'
                    }`}
                  >
                    <span className="truncate text-[11.5px]">{chat.title}</span>
                    <span className="text-[9px] text-gray-500 light:text-gray-400 mt-0.5">{chat.time}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="flex-1 bg-[#0a0a0a] light:bg-[#ffffff] flex flex-col justify-between p-6 relative overflow-hidden">
          ...
          {selectedChat ? (
                  ...
                  <div 
                    className={`p-3.5 rounded-2xl max-w-[80%] shadow-sm ${
                      m.role === 'user'
                        ...
                        : 'bg-[#161616] light:bg-[#f3f4f6] text-gray-200 light:text-gray-800 border border-white/10 light:border-black/10 rounded-tl-none'
                    }`}
                  >
                    <p>{m.text}</p>
                    <span className={`text-[9px] mt-1.5 block ${m.role === 'user' ? 'text-black/70' : 'text-gray-500'}`}>
                      {m.time}
                    </span>
                  </div>

                  {m.role === 'user' && (
                    <div className="w-7 h-7 rounded-lg bg-[#222] light:bg-[#ddd] text-gray-200 light:text-gray-800 flex items-center justify-center shrink-0 mt-1 font-semibold text-[11px]">
                      U
                    </div>
                  )}
                </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center max-w-xl mx-auto text-center gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs md:text-[13px] text-gray-400 light:text-gray-600 leading-relaxed max-w-md">
          ...
          <div className="w-full max-w-3xl mx-auto relative mt-auto">
            ...
            <div className="flex items-center justify-between px-2 pt-1.5 text-[10px] text-gray-500 light:text-gray-400">
