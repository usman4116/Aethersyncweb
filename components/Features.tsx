    ...
    <section id="features" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
          Engineered for the <span className="neon-gradient-text">Next Generation</span> of Software
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map((feat, idx) => {
          ...
          return (
            <div
              key={idx}
              className="group relative rounded-2xl border border-white/[0.08] bg-[#0c0c12]/80 p-7 backdrop-blur-xl transition-all duration-300 hover:border-orange-500/40 hover:bg-[#11111a] hover:shadow-2xl hover:shadow-orange-500/10"
            >
              <div className="w-12 h-12 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 mb-5 group-hover:scale-110 group-hover:bg-orange-500/20 transition-transform">
                <Icon size={22} />
              </div>
