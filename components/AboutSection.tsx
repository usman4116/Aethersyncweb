...
export function AboutSection() {
  return (
    <section id="about" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="rounded-3xl border border-white/[0.1] bg-gradient-to-b from-[#0e0e16] to-[#07070a] p-8 sm:p-14 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
        {/* Ambient Glow */}
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight">
            ...
            <span className="neon-gradient-text">Agentic Coding.</span>
          </h2>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 border-t border-white/[0.08]">
            <div>
              <div className="text-2xl sm:text-3xl font-black text-white">100%</div>
              <div className="text-xs text-slate-400 mt-1">Local-First Privacy</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-black text-orange-400">&lt; 100ms</div>
              <div className="text-xs text-slate-400 mt-1">Local PTY Terminal Latency</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl font-black text-white">4+</div>
              <div className="text-xs text-slate-400 mt-1">Frontier AI Model Families</div>
            </div>
          </div>
        </div>
      </div>
