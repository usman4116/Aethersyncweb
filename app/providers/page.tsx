      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="aether-card rounded-2xl p-6">
            <Key size={22} className="text-purple-400 mb-3" />
            <h3 className="text-base font-bold text-white mb-1.5">OS Keyring Storage</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              API secrets are encrypted locally with native Windows Credential Manager / safeStorage APIs.
            </p>
          </div>
          <div className="aether-card rounded-2xl p-6">
            <RefreshCw size={22} className="text-purple-400 mb-3" />
            <h3 className="text-base font-bold text-white mb-1.5">Dynamic Hot-Swapping</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Switch from Claude 3.7 to DeepSeek R1 mid-conversation without interrupting terminal tasks.
            </p>
          </div>
          <div className="aether-card rounded-2xl p-6">
            <ShieldCheck size={22} className="text-purple-400 mb-3" />
            <h3 className="text-base font-bold text-white mb-1.5">Zero Intermediary Proxies</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
