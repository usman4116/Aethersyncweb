  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <section className="pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
        <div className="aether-card rounded-3xl p-8 sm:p-12 border border-primary/30 shadow-2xl relative overflow-hidden">
          <div className="glow-orb -top-10 -right-10 w-72 h-72 bg-primary/20" />
          ...
          <div className="mt-6 flex justify-center">
            <a
              href={DOWNLOAD_LINK}
              download
              className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-primary text-foreground font-bold text-sm shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all duration-200"
            >
              <Download size={16} />
